...
awful.key({modkey}, "r", function()
    awful.util.spawn("rofi -show drun -theme breeze-dark")
end, {
...
awful.key({}, "Print", function(c)
    awful.util.spawn(screenshot_script, false)
end, {
...
end, {}), awful.key({modkey}, "i", function()
    if (screen.primary.sidemenu.visible == true) then
